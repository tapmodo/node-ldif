module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c6 = function(ver, entries) { return { version: ver, type: 'changes', changes: entries }; },
        peg$c7 = function(dn, ctrl, changes) { return { dn: dn, control: ctrl, changes: changes }; },
        peg$c8 = { type: "other", description: "control" },
        peg$c9 = "control:",
        peg$c10 = { type: "literal", value: "control:", description: "\"control:\"" },
        peg$c11 = "true",
        peg$c12 = { type: "literal", value: "true", description: "\"true\"" },
        peg$c13 = "false",
        peg$c14 = { type: "literal", value: "false", description: "\"false\"" },
        peg$c15 = function(oid, crit, val) {
              return {
                controlType: oid,
        ...
        peg$c16 = { type: "other", description: "changetype" },
        peg$c17 = "changetype:",
        peg$c18 = { type: "literal", value: "changetype:", description: "\"changetype:\"" },
        peg$c19 = function(change) { return change; },
        peg$c20 = "add",
        peg$c21 = { type: "literal", value: "add", description: "\"add\"" },
        peg$c22 = function(attribs) {
            return {
              type: 'add',
              attributes: attribs
            };
        ...
        peg$c23 = "delete",
        peg$c24 = { type: "literal", value: "delete", description: "\"delete\"" },
        peg$c25 = function() { return { type: 'delete' }; },
        peg$c26 = "modrdn",
        peg$c27 = { type: "literal", value: "modrdn", description: "\"modrdn\"" },
        peg$c28 = "moddn",
        peg$c29 = { type: "literal", value: "moddn", description: "\"moddn\"" },
        peg$c30 = "newrdn:",
        peg$c31 = { type: "literal", value: "newrdn:", description: "\"newrdn:\"" },
        peg$c32 = "deleteoldrdn:",
        peg$c33 = { type: "literal", value: "deleteoldrdn:", description: "\"deleteoldrdn:\"" },
        peg$c34 = "0",
        peg$c35 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c36 = "1",
        peg$c37 = { type: "literal", value: "1", description: "\"1\"" },
        peg$c38 = function(type, delold, newsup) {
              return { type: type, deleteoldrdn: delold, newsuperior: newsup || null }
            },
        peg$c39 = "newsuperior::",
        peg$c40 = { type: "literal", value: "newsuperior::", description: "\"newsuperior::\"" },
        peg$c41 = function(dn) { return dn; },
        peg$c42 = "newsuperior:",
        peg$c43 = { type: "literal", value: "newsuperior:", description: "\"newsuperior:\"" },
        peg$c44 = "modify",
        peg$c45 = { type: "literal", value: "modify", description: "\"modify\"" },
        peg$c46 = function(mods) {
            return { type: 'modify', changes: mods };
          },
        peg$c47 = "replace",
        peg$c48 = { type: "literal", value: "replace", description: "\"replace\"" },
        peg$c49 = ":",
        peg$c50 = { type: "literal", value: ":", description: "\":\"" },
        peg$c51 = "-",
        peg$c52 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c53 = function(type, attr, values) {
              values = _pluck(values,'value');
              return { type: type, attribute: attr, values: values };
            },
        peg$c54 = function(ver, entries) {
            return { version: ver, type: 'content', entries: entries };
          },
        peg$c55 = { type: "other", description: "entry" },
        peg$c56 = function(dn, attribs) {
        ...
        peg$c62 = function(dn) { return base64(dn); },
        ...
        peg$c80 = function(oid) { return new OID(oid); },
        peg$c81 = { type: "other", description: "attribute type chars" },
        peg$c82 = { type: "other", description: "OID" },
        peg$c83 = ".",
        peg$c84 = { type: "literal", value: ".", description: "\".\"" },
        peg$c85 = { type: "other", description: "attribute value" },
        peg$c86 = function(left, right) { return left + right; },
        peg$c87 = { type: "other", description: "continuation" },
        peg$c88 = { type: "other", description: "whitespace" },
        peg$c89 = /^[s]/,
        peg$c90 = { type: "class", value: "[\\s]", description: "[\\s]" },
        peg$c91 = { type: "other", description: "comment" },
        peg$c92 = "#",
        peg$c93 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c94 = { type: "any", description: "any character" },
        peg$c95 = { type: "other", description: "space fill" },
        peg$c96 = { type: "other", description: "single space" },
        peg$c97 = /^[ ]/,
        peg$c98 = { type: "class", value: "[\\x20]", description: "[\\x20]" },
        peg$c99 = { type: "other", description: "digit" },
        peg$c100 = /^[0-9]/,
        peg$c101 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c102 = { type: "other", description: "alpha" },
        peg$c103 = /^[a-zA-Z]/,
        peg$c104 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
        peg$c105 = /^[+\/0-9=A-Za-z]/,
        peg$c106 = { type: "class", value: "[\\x2B\\x2F\\x30-\\x39\\x3D\\x41-\\x5A\\x61-\\x7A]", description: "[\\x2B\\x2F\\x30-\\x39\\x3D\\x41-\\x5A\\x61-\\x7A]" },
        peg$c107 = { type: "other", description: "safestring" },
        peg$c108 = /^[\x01-\t\x0B-\f\x0E-\x1F!-9;=-]/,
        peg$c109 = { type: "class", value: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x1F\\x21-\\x39\\x3B\\x3D-\\x7F]", description: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x1F\\x21-\\x39\\x3B\\x3D-\\x7F]" },
        peg$c110 = { type: "other", description: "SAFE CHAR" },
        peg$c111 = /^[\x01-\t\x0B-\f\x0E-]/,
        peg$c112 = { type: "class", value: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x7F]", description: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x7F]" },
        peg$c113 = { type: "other", description: "newline" },
        peg$c114 = "\r\n",
