...
ldif_entry "entry"
  = dn:dn_spec SEP attribs:attrs_spec whitespace* {
    return new type.Record(dn,attribs);
  }
...
ldif_changes
  = whitespace* ver:version_spec? entries:ldif_change+
    { return { version: ver, type: 'changes', entries: entries }; }
...
attrval_spec "attribute value line"
  = attr:AttributeDescription "::" FILL val:base64_value_spec SEP? {
    return { attribute: attr, value: { type: 'value', value: base64_decode(val) } };
  }
  / attr:AttributeDescription ":<" FILL val:value_spec SEP? {
    return { attribute: attr, value: { type: 'file', value: val } };
  }
  / attr:AttributeDescription ":" FILL val:value_spec SEP? {
    return { attribute: attr, value: { type: 'value', value: val } };
  }
