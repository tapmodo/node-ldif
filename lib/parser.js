module.exports = (function () {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
      ...
      peg$c89 = { type: "other", description: "attribute value dn" },
      peg$c90 = function (left, right) { return left + right; },
      peg$c91 = { type: "other", description: "attribute value" },
      peg$c92 = { type: "other", description: "continuation" },
      peg$c93 = { type: "other", description: "base64-encoded value" },
      peg$c94 = { type: "other", description: "WHITESPACE" },
      peg$c95 = /^[s]/,
      peg$c96 = { type: "class", value: "[\\s]", description: "[\\s]" },
      peg$c97 = { type: "other", description: "COMMENT" },
      peg$c98 = "#",
      peg$c99 = { type: "literal", value: "#", description: "\"#\"" },
      peg$c100 = { type: "any", description: "any character" },
      peg$c101 = { type: "other", description: "FILL" },
      peg$c102 = { type: "other", description: "SPACE" },
      peg$c103 = /^[ ]/,
      peg$c104 = { type: "class", value: "[\\x20]", description: "[\\x20]" },
      peg$c105 = { type: "other", description: "DIGIT" },
      peg$c106 = /^[0-9]/,
      peg$c107 = { type: "class", value: "[0-9]", description: "[0-9]" },
      peg$c108 = { type: "other", description: "ALPHA" },
      peg$c109 = /^[a-zA-Z]/,
      peg$c110 = { type: "class", value: "[a-zA-Z]", description: "[a-zA-Z]" },
      peg$c111 = { type: "other", description: "BASE64 STRING" },
      peg$c112 = { type: "other", description: "BASE64 CHAR" },
      peg$c113 = /^[+\/0-9=A-Za-z]/,
      peg$c114 = { type: "class", value: "[\\x2B\\x2F\\x30-\\x39\\x3D\\x41-\\x5A\\x61-\\x7A]", description: "[\\x2B\\x2F\\x30-\\x39\\x3D\\x41-\\x5A\\x61-\\x7A]" },
      peg$c115 = { type: "other", description: "SAFE STRING" },
      peg$c116 = { type: "other", description: "SAFE STRING EMPTY DN" },
      peg$c117 = { type: "other", description: "SAFE INITIALIZER DN" },
      peg$c118 = /^[\x01-\t\x0B-\f\x0E-9;=-]/,
      peg$c119 = { type: "class", value: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x39\\x3B\\x3D-\\x7F]", description: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x39\\x3B\\x3D-\\x7F]" },
      peg$c120 = { type: "other", description: "SAFE INITIALIZER" },
      peg$c121 = /^[\x01-\t\x0B-\f\x0E-\x1F!-9;=-]/,
      peg$c122 = { type: "class", value: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x1F\\x21-\\x39\\x3B\\x3D-\\x7F]", description: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x1F\\x21-\\x39\\x3B\\x3D-\\x7F]" },
      peg$c123 = { type: "other", description: "SAFE CHAR" },
      peg$c124 = /^[\x01-\t\x0B-\f\x0E-]/,
      peg$c125 = { type: "class", value: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x7F]", description: "[\\x01-\\x09\\x0B-\\x0C\\x0E-\\x7F]" },
      peg$c126 = { type: "other", description: "NEWLINE" },
      peg$c127 = "\r\n",
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          ...
          if (s1 !== peg$FAILED) {
            ...
            if (s2 !== peg$FAILED) {
              s3 = peg$parseemptyDistinguishedName();
              if (s3 !== peg$FAILED) {
                peg$savedPos = s0;
                s1 = peg$c44(s3);
                s0 = s1;
    ...
    function peg$parseemptyDistinguishedName() {
      var s0, s1;

      peg$silentFails++;
      s0 = peg$parsevalue_spec_dn();
      peg$silentFails--;
      if (s0 === peg$FAILED) {
        s1 = peg$FAILED;
    ...
    function peg$parsevalue_spec_dn() {
      var s0, s1, s2, s3, s4;

      peg$silentFails++;
      s0 = peg$currPos;
      s1 = peg$parseSAFE_STRING_EMPTY_DN();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseSEP();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseSPACE();
    ...
    function peg$parseSAFE_STRING_EMPTY_DN() {
      var s0, s1, s2, s3, s4;

      peg$silentFails++;
      s0 = peg$currPos;
      s1 = peg$currPos;
      s2 = peg$parseSAFE_INIT_CHAR_DN();
      if (s2 !== peg$FAILED) {
        s3 = [];
        s4 = peg$parseSAFE_CHAR();
        while (s4 !== peg$FAILED) {
    ...
    function peg$parseSAFE_INIT_CHAR_DN() {
      var s0, s1;
