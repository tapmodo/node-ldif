...
dn_spec "DN"
  ...
  / comment_line* "dn:" dn:emptyDistinguishedName
    { return dn; }

emptyDistinguishedName "distinguishedName"
  = value_spec_dn
...
value_spec_dn "attribute value dn"
  = left:SAFE_STRING_EMPTY_DN SEP SPACE right:value_recurse { return left + right; }
  / $ SAFE_STRING_EMPTY_DN
...
SAFE_STRING_EMPTY_DN "SAFE STRING EMPTY DN"
  = $(SAFE_INIT_CHAR_DN SAFE_CHAR*)

SAFE_INIT_CHAR_DN "SAFE INITIALIZER DN"
  = $ [\x01-\x09\x0B-\x0C\x0E-\x39\x3B\x3D-\x7F]
